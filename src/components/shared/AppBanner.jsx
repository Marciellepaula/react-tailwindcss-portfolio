  ...
  return (
    ...
    >
      <div className="w-full md:w-1/3 text-left">
        ...
        >
          <a
            download="Marcielle de Paula Jorge - Currículo.pdf"
            href="/files/Marcielle de Paula Jorge - Currículo.pdf"
      ...
      <motion.div
        ...
        transition={{ ease: "easeInOut", duration: 0.9, delay: 0.2 }}
        className="w-full sm:w-3/4 text-right float-right mt-8 sm:mt-0"
      >
        <img
